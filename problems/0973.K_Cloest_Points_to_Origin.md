...
## Method 1. Arrays.sort() with customized Comparator (22ms, beats 83%)
```java
class Solution {
...
## Method 2. PriorityQueue -- minHeap (My implementation, 21ms, beats 88%)
```java
class Solution {
    public int[][] kClosest(int[][] points, int K) {
...
## Method 2. PriorityQueue -- maxHeap (29ms, beats 64%)
```java
class Solution {
    public int[][] kClosest(int[][] points, int k) {
