...
class Solution {
    ...
    private int quickSelect(List<Integer> nums, int k) {
        ...
        List<Integer> left = new ArrayList<>();     // left is the section with elements greater than the pivot
        List<Integer> mid = new ArrayList<>();      // mid is the section with elements equal to the pivot
        List<Integer> right = new ArrayList<>();    // right is the section with elements smallern than the pivot
