...
## ✅⭐ Method 2. Bucket Sort (4ms, beats 97%)
```java
class Solution {
    public int findKthLargest(int[] nums, int k) {
...
## ✅⭐ Method 3. Quick Select (11ms, beats 94%)
```java
class Solution {
    public int findKthLargest(int[] nums, int k) {
...
## Method 1. PriorityQueue, Heap (最简单的写法, 63ms, beats 31%)
...
## Method 3. QuickSelect + List (34ms, beats 76%)
```Java
class Solution {
    public int findKthLargest(int[] nums, int k) {
