...
[My Java implementation](https://leetcode.com/playground/Pxx3rabY)
```java
...
## Reference
2. [Closest Pair of Points using Divide and Conquer algorithm](https://www.geeksforgeeks.org/closest-pair-of-points-using-divide-and-conquer-algorithm/)
1. [0007算法笔记——【分治法】最接近点对问题](https://blog.csdn.net/liufeng_king/article/details/8484284)